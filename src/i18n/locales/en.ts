...
export const en: TranslationMap = {
  ...
  wizard: {
    ...
    finalize: {
      ...
      webSearchKeyStored: "API key: stored in config (tools.web.search.{path}).",
      webSearchKeyEnv: "API key: provided via {envVar} env var (Gateway environment).",
      webSearchSetupIntro: "To enable web search, your agent will need an API key for either Perplexity Search or Brave Search.",
      webSearchSetupInteractive: "Set it up interactively:",
      webSearchSetupCmd: "- Run: {cmd}",
      webSearchChooseProvider: "- Choose a provider and paste your API key",
      webSearchAltEnv: "Alternative: set PERPLEXITY_API_KEY or BRAVE_API_KEY in the Gateway environment (no config changes).",
      webSearchNoteTitle: "Web search (optional)",
      webSearchNoteEnabledTitle: "Web search",
  ...
  commands: {
    ...
    configWiz: {
      ...
      perplexityKeyExisting: "Perplexity API key (leave blank to keep current or use PERPLEXITY_API_KEY)",
      perplexityKeyNew: "Perplexity API key (paste it here; leave blank to use PERPLEXITY_API_KEY)",
      keepCurrent: "Leave blank to keep current",
      noKeyNote: "No key stored yet, so web_search will stay unavailable.\nStore a key here or set {envVar} in the Gateway environment.\nGet your API key at: {url}\nDocs: https://docs.openclaw.ai/tools/web",
      braveKeyExisting: "Brave Search API key (leave blank to keep current or use BRAVE_API_KEY)",
      braveKeyNew: "Brave Search API key (paste it here; leave blank to use BRAVE_API_KEY)",
