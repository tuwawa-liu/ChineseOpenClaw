...
Object.assign(en, {
  ...
  subClis: {
    acpDesc: "Agent Control Protocol tools",
    gatewayDesc: "Run, inspect, and query the WebSocket Gateway",
    daemonDesc: "Gateway service (legacy alias)",
    logsDesc: "Tail gateway file logs via RPC",
    systemDesc: "System events, heartbeat, and presence",
    modelsDesc: "Discover, scan, and configure models",
    approvalsDesc: "Manage exec approvals (gateway or node host)",
    nodesDesc: "Manage gateway-owned node pairing and node commands",
    devicesDesc: "Device pairing + token management",
    nodeDesc: "Run and manage the headless node host service",
    sandboxDesc: "Manage sandbox containers for agent isolation",
    tuiDesc: "Open a terminal UI connected to the Gateway",
    cronDesc: "Manage cron jobs via the Gateway scheduler",
    dnsDesc: "DNS helpers for wide-area discovery (Tailscale + CoreDNS)",
    docsDesc: "Search the live OpenClaw docs",
    hooksDesc: "Manage internal agent hooks",
    webhooksDesc: "Webhook helpers and integrations",
    qrDesc: "Generate iOS pairing QR/setup code",
    clawbotDesc: "Legacy clawbot command aliases",
    pairingDesc: "Secure DM pairing (approve inbound requests)",
    pluginsDesc: "Manage OpenClaw plugins and extensions",
    channelsDesc: "Manage connected chat channels (Telegram, Discord, etc.)",
    directoryDesc: "Lookup contact and group IDs (self, peers, groups) for supported chat channels",
    securityDesc: "Security tools and local config audits",
    secretsDesc: "Secrets runtime reload controls",
    skillsDesc: "List and inspect available skills",
    updateDesc: "Update OpenClaw and inspect update channel status",
    completionDesc: "Generate shell completion script",
  },

  // src/cli/program/register.agent.ts
  agentCli: {
    agentDesc: "Run an agent turn via the Gateway (use --local for embedded)",
    messageOpt: "Message body for the agent",
    toOpt: "Recipient number in E.164 used to derive the session key",
    sessionIdOpt: "Use an explicit session id",
    agentIdOpt: "Agent id (overrides routing bindings)",
    thinkingOpt: "Thinking level: off | minimal | low | medium | high",
    verboseOpt: "Persist agent verbose level for the session",
    channelOpt: "Delivery channel: {channels} (omit to use the main session channel)",
    replyToOpt: "Delivery target override (separate from session routing)",
    replyChannelOpt: "Delivery channel override (separate from routing)",
    replyAccountOpt: "Delivery account id override",
    localOpt: "Run the embedded agent locally (requires model provider API keys in your shell)",
    deliverOpt: "Send the agent's reply back to the selected channel",
    jsonOpt: "Output result as JSON",
    timeoutOpt: "Override agent command timeout (seconds, default 600 or config value)",
    agentsDesc: "Manage isolated agents (workspaces + auth + routing)",
    listDesc: "List configured agents",
    listJsonOpt: "Output JSON instead of text",
    listBindingsOpt: "Include routing bindings",
    bindingsDesc: "List routing bindings",
    bindingsAgentOpt: "Filter by agent id",
    bindingsJsonOpt: "Output JSON instead of text",
    bindDesc: "Add routing bindings for an agent",
    bindAgentOpt: "Agent id (defaults to current default agent)",
    bindBindOpt:
      "Binding to add (repeatable). If omitted, accountId is resolved by channel defaults/hooks.",
    bindJsonOpt: "Output JSON summary",
    unbindDesc: "Remove routing bindings for an agent",
    unbindAgentOpt: "Agent id (defaults to current default agent)",
    unbindBindOpt: "Binding to remove (repeatable)",
    unbindAllOpt: "Remove all bindings for this agent",
    unbindJsonOpt: "Output JSON summary",
    addDesc: "Add a new isolated agent",
    addWorkspaceOpt: "Workspace directory for the new agent",
    addModelOpt: "Model id for this agent",
    addAgentDirOpt: "Agent state directory for this agent",
    addBindOpt: "Route channel binding (repeatable)",
    addNonInteractiveOpt: "Disable prompts; requires --workspace",
    addJsonOpt: "Output JSON summary",
    setIdentityDesc: "Update an agent identity (name/theme/emoji/avatar)",
    setIdentityAgentOpt: "Agent id to update",
    setIdentityWorkspaceOpt: "Workspace directory used to locate the agent + IDENTITY.md",
    setIdentityFileOpt: "Explicit IDENTITY.md path to read",
    setIdentityFromOpt: "Read values from IDENTITY.md",
    setIdentityNameOpt: "Identity name",
    setIdentityThemeOpt: "Identity theme",
    setIdentityEmojiOpt: "Identity emoji",
    setIdentityAvatarOpt: "Identity avatar (workspace path, http(s) URL, or data URI)",
    setIdentityJsonOpt: "Output JSON summary",
    deleteDesc: "Delete an agent and prune workspace/state",
    deleteForceOpt: "Skip confirmation",
    deleteJsonOpt: "Output JSON summary",
  },

  // src/cli/program/register.backup.ts
  backupCli: {
    backupDesc: "Create and verify local backup archives for OpenClaw state",
    createDesc: "Write a backup archive for config, credentials, sessions, and workspaces",
    createOutputOpt: "Archive path or destination directory",
    createJsonOpt: "Output JSON",
    createDryRunOpt: "Print the backup plan without writing the archive",
    createVerifyOpt: "Verify the archive after writing it",
    createOnlyConfigOpt: "Back up only the active JSON config file",
    createNoWorkspaceOpt: "Exclude workspace directories from the backup",
    verifyDesc: "Validate a backup archive and its embedded manifest",
    verifyJsonOpt: "Output JSON",
  },

  // src/cli/program/register.setup.ts
  setupCli: {
    setupDesc: "Initialize ~/.openclaw/openclaw.json and the agent workspace",
    workspaceOpt:
      "Agent workspace directory (default: ~/.openclaw/workspace; stored as agents.defaults.workspace)",
    wizardOpt: "Run the interactive onboarding wizard",
    nonInteractiveOpt: "Run the wizard without prompts",
    modeOpt: "Wizard mode: local|remote",
    remoteUrlOpt: "Remote Gateway WebSocket URL",
    remoteTokenOpt: "Remote Gateway token (optional)",
  },

  // src/cli/program/register.message.ts
  messageCli: {
    messageDesc: "Send, read, and manage messages and channel actions",
  },

  // src/cli/program/register.status-health-sessions.ts
  statusCli: {
    statusDesc: "Show channel health and recent session recipients",
    jsonOpt: "Output JSON instead of text",
    allOpt: "Full diagnosis (read-only, pasteable)",
    usageOpt: "Show model provider usage/quota snapshots",
    deepOpt: "Probe channels (WhatsApp Web + Telegram + Discord + Slack + Signal)",
    timeoutOpt: "Probe timeout in milliseconds",
    verboseOpt: "Verbose logging",
    debugOpt: "Alias for --verbose",
    healthDesc: "Fetch health from the running gateway",
    healthJsonOpt: "Output JSON instead of text",
    healthTimeoutOpt: "Connection timeout in milliseconds",
    healthVerboseOpt: "Verbose logging",
    healthDebugOpt: "Alias for --verbose",
    sessionsDesc: "List stored conversation sessions",
    sessionsJsonOpt: "Output as JSON",
    sessionsVerboseOpt: "Verbose logging",
    sessionsStoreOpt: "Path to session store (default: resolved from config)",
    sessionsAgentOpt: "Agent id to inspect (default: configured default agent)",
    sessionsAllAgentsOpt: "Aggregate sessions across all configured agents",
    sessionsActiveOpt: "Only show sessions updated within the past N minutes",
    cleanupDesc: "Run session-store maintenance now",
    cleanupStoreOpt: "Path to session store (default: resolved from config)",
    cleanupAgentOpt: "Agent id to maintain (default: configured default agent)",
    cleanupAllAgentsOpt: "Run maintenance across all configured agents",
    cleanupDryRunOpt: "Preview maintenance actions without writing",
    cleanupEnforceOpt: "Apply maintenance even when configured mode is warn",
    cleanupFixMissingOpt:
      "Remove store entries whose transcript files are missing (bypasses age/count retention)",
    cleanupActiveKeyOpt: "Protect this session key from budget-eviction",
    cleanupJsonOpt: "Output JSON",
  },

  // src/cli/program/message/helpers.ts + register.*.ts
  msgCli: {
    // helpers.ts (shared options)
    channelOpt: "Channel: {channels}",
    accountOpt: "Channel account id (accountId)",
    jsonOpt: "Output result as JSON",
    dryRunOpt: "Print payload and skip sending",
    verboseOpt: "Verbose logging",
    // register.send.ts
    sendDesc: "Send a message",
    sendMessageOpt: "Message body (required unless --media is set)",
    sendMediaOpt: "Attach media (image/audio/video/document). Accepts local paths or URLs.",
    sendButtonsOpt: "Telegram inline keyboard buttons as JSON (array of button rows)",
    sendComponentsOpt: "Discord components payload as JSON",
    sendCardOpt: "Adaptive Card JSON object (when supported by the channel)",
    sendReplyToOpt: "Reply-to message id",
    sendThreadIdOpt: "Thread id (Telegram forum thread)",
    sendGifPlaybackOpt: "Treat video media as GIF playback (WhatsApp only).",
    sendSilentOpt: "Send message silently without notification (Telegram + Discord)",
    // register.broadcast.ts
    broadcastDesc: "Broadcast a message to multiple targets",
    broadcastMessageOpt: "Message to send",
    broadcastMediaOpt: "Media URL",
    // register.poll.ts
    pollDesc: "Send a poll",
    pollQuestionOpt: "Poll question",
    pollOptionOpt: "Poll option (repeat 2-12 times)",
    pollMultiOpt: "Allow multiple selections",
    pollDurationHoursOpt: "Poll duration in hours (Discord)",
    pollDurationSecondsOpt: "Poll duration in seconds (Telegram; 5-600)",
    pollAnonymousOpt: "Send an anonymous poll (Telegram)",
    pollPublicOpt: "Send a non-anonymous poll (Telegram)",
    pollMessageOpt: "Optional message body",
    pollSilentOpt: "Send poll silently without notification (Telegram + Discord where supported)",
    pollThreadIdOpt: "Thread id (Telegram forum topic / Slack thread ts)",
    // register.reactions.ts
    reactDesc: "Add or remove a reaction",
    reactMessageIdOpt: "Message id",
    reactEmojiOpt: "Emoji for reactions",
    reactRemoveOpt: "Remove reaction",
    reactParticipantOpt: "WhatsApp reaction participant",
    reactFromMeOpt: "WhatsApp reaction fromMe",
    reactTargetAuthorOpt: "Signal reaction target author (uuid or phone)",
    reactTargetAuthorUuidOpt: "Signal reaction target author uuid",
    reactionsDesc: "List reactions on a message",
    reactionsMessageIdOpt: "Message id",
    reactionsLimitOpt: "Result limit",
    // register.read-edit-delete.ts
    readDesc: "Read recent messages",
    readLimitOpt: "Result limit",
    readBeforeOpt: "Read/search before id",
    readAfterOpt: "Read/search after id",
    readAroundOpt: "Read around id",
    readIncludeThreadOpt: "Include thread replies (Discord)",
    editDesc: "Edit a message",
    editMessageIdOpt: "Message id",
    editMessageOpt: "Message body",
    editThreadIdOpt: "Thread id (Telegram forum thread)",
    deleteDesc: "Delete a message",
    deleteMessageIdOpt: "Message id",
    // register.discord-admin.ts
    roleDesc: "Role actions",
    roleInfoDesc: "List roles",
    roleAddDesc: "Add role to a member",
    roleRemoveDesc: "Remove role from a member",
    guildIdOpt: "Guild id",
    userIdOpt: "User id",
    roleIdOpt: "Role id",
    channelActionsDesc: "Channel actions",
    channelInfoDesc: "Fetch channel info",
    channelListDesc: "List channels",
    memberDesc: "Member actions",
    memberInfoDesc: "Fetch member info",
    memberGuildIdOpt: "Guild id (Discord)",
    voiceDesc: "Voice actions",
    voiceStatusDesc: "Fetch voice status",
    eventDesc: "Event actions",
    eventListDesc: "List scheduled events",
    eventCreateDesc: "Create a scheduled event",
    eventNameOpt: "Event name",
    eventStartTimeOpt: "Event start time",
    eventEndTimeOpt: "Event end time",
    eventDescOpt: "Event description",
    eventChannelIdOpt: "Channel id",
    eventLocationOpt: "Event location",
    eventTypeOpt: "Event type",
    timeoutDesc: "Timeout a member",
    timeoutDurationOpt: "Timeout duration minutes",
    timeoutUntilOpt: "Timeout until",
    moderationReasonOpt: "Moderation reason",
    kickDesc: "Kick a member",
    banDesc: "Ban a member",
    banDeleteDaysOpt: "Ban delete message days",
    // register.emoji-sticker.ts
    emojiDesc: "Emoji actions",
    emojiListDesc: "List emojis",
    emojiGuildIdOpt: "Guild id (Discord)",
    emojiUploadDesc: "Upload an emoji",
    emojiNameOpt: "Emoji name",
    emojiMediaOpt: "Emoji media (path or URL)",
    emojiRoleIdsOpt: "Role id (repeat)",
    stickerDesc: "Sticker actions",
    stickerSendDesc: "Send stickers",
    stickerIdOpt: "Sticker id (repeat)",
    stickerMessageOpt: "Optional message body",
    stickerUploadDesc: "Upload a sticker",
    stickerNameOpt: "Sticker name",
    stickerDescOpt: "Sticker description",
    stickerTagsOpt: "Sticker tags",
    stickerMediaOpt: "Sticker media (path or URL)",
    // register.permissions-search.ts
    permissionsDesc: "Fetch channel permissions",
    searchDesc: "Search Discord messages",
    searchQueryOpt: "Search query",
    searchChannelIdOpt: "Channel id",
    searchChannelIdsOpt: "Channel id (repeat)",
    searchAuthorIdOpt: "Author id",
    searchAuthorIdsOpt: "Author id (repeat)",
    searchLimitOpt: "Result limit",
    // register.pins.ts
    pinDesc: "Pin a message",
    pinMessageIdOpt: "Message id",
    unpinDesc: "Unpin a message",
    unpinMessageIdOpt: "Message id",
    pinsDesc: "List pinned messages",
    pinsLimitOpt: "Result limit",
    // register.thread.ts
    threadDesc: "Thread actions",
    threadCreateDesc: "Create a thread",
    threadNameOpt: "Thread name",
    threadMessageIdOpt: "Message id (optional)",
    threadMessageOpt: "Initial thread message text",
    threadAutoArchiveOpt: "Thread auto-archive minutes",
    threadListDesc: "List threads",
    threadChannelIdOpt: "Channel id",
    threadIncludeArchivedOpt: "Include archived threads",
    threadBeforeOpt: "Read/search before id",
    threadLimitOpt: "Result limit",
    threadReplyDesc: "Reply in a thread",
    threadReplyMessageOpt: "Message body",
    threadReplyMediaOpt: "Attach media (image/audio/video/document). Accepts local paths or URLs.",
    threadReplyToOpt: "Reply-to message id",
  },
});
